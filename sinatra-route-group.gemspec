...
Gem::Specification.new do |s|
  s.name = %q{sinatra-route-group}
  s.version = "0.0.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Takayuki Miwa"]
  s.date = %q{2010-03-25}
  s.description = %q{A Sinatra extension for grouping routes. See README for more details.}
  s.email = %q{i@tkyk.name}
  s.extra_rdoc_files = [
    "LICENSE",
     "README.rdoc"
  ]
